...
FUNCTIONAL_SOURCE_DETAILS = {
    ...
    "FR-WS-018": "WT-158/DB-AI; code: DeleteDocumentAsync, OutboxWorkspaceDocumentEventPublisher delete/archive events",
    ...
    "FR-WS-021": "WT-158-AI/PII/RabbitMQ; code: IWorkspaceDocumentEventPublisher, OutboxWorkspaceDocumentEventPublisher, DocumentAiIngestionConsumerService; target: RabbitMQ durable delivery",
