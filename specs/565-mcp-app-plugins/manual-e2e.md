...
- Pending: Enable/configure Google Calendar API for the Google Cloud project and re-run confirmed Calendar write; obtain a clean standard AssistantService Docker build instead of the runtime-smoke image workaround.
