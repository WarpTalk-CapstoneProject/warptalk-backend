...
namespace WarpTalk.BillingService.Infrastructure.Migrations
{
    ...
    [Migration("20260710152805_ScaffoldRefundAndInvoice")]
    partial class ScaffoldRefundAndInvoice
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WarpTalk.BillingService.Domain.Entities.Plan", b =>
                {
                    ...
                    b.Property<bool>("AllowAcl")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("allow_acl");

                    b.Property<bool>("AllowGlossary")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                    ...
                    b.Property<int>("VoiceCloneLimitMins")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
