...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WarpTalk.BillingService.Domain.Entities.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("invoices", "subscription");
                });
            ...
            modelBuilder.Entity("WarpTalk.BillingService.Domain.Entities.Refund", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("refunds", "subscription");
                });
            ...
            modelBuilder.Entity("WarpTalk.BillingService.Domain.Entities.WebhookEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("webhook_events_pkey");

                    b.HasIndex(new[] { "Provider", "EventId" }, "idx_webhook_events_provider_event_id")
                        .IsUnique();

                    b.ToTable("webhook_events", "subscription");
                });
            ...
            modelBuilder.Entity("WarpTalk.BillingService.Domain.Entities.Invoice", b =>
                {
                    b.HasOne("WarpTalk.BillingService.Domain.Entities.Payment", "Payment")
                        .WithMany("Invoices")
