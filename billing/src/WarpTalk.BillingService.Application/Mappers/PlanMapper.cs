...
public static class PlanMapper
{
    ...
    public static Plan CreateDefaultEnterprisePlan() => new()
    {
        ...
        Slug = "enterprise",
        Tier = "enterprise",
        Price = SubscriptionConstants.EnterpriseBaseline.PriceVnd,
        Currency = "VND",
        BillingCycle = SubscriptionConstants.BillingCycles.Monthly,
        CreditsPerCycle = SubscriptionConstants.EnterpriseBaseline.CreditsPerCycle,
        OverageCapCredits = SubscriptionConstants.EnterpriseBaseline.OverageCapCredits,
        OveragePricePerCredit = SubscriptionConstants.EnterpriseBaseline.OveragePricePerCredit,
        LowBalanceThresholdCredits = SubscriptionConstants.EnterpriseBaseline.LowBalanceThresholdCredits,
        RolloverCapCredits = SubscriptionConstants.EnterpriseBaseline.RolloverCapCredits,
        InvoiceTermsDays = SubscriptionConstants.EnterpriseBaseline.InvoiceTermsDays,
        InvoiceGraceHours = SubscriptionConstants.EnterpriseBaseline.InvoiceGraceHours,
