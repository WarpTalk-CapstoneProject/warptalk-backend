...
public interface IStripePaymentService
{
    ...
    Task<Result<bool>> UpdateSubscriptionAsync(UpdateStripeSubscriptionRequest request, CancellationToken cancellationToken = default);
    ...
    Task<Result<bool>> RefundPaymentAsync(string providerTransactionId, CancellationToken cancellationToken = default);
