...
namespace WarpTalk.AssistantService.Tests.Architecture;
...
{
    private static readonly System.Reflection.Assembly Api = typeof(WarpTalk.AssistantService.API.Controllers.AssistantPluginCatalogController).Assembly;
