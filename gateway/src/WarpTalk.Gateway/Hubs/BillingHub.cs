...
public class BillingHub : Hub
{
    ...
    public override async Task OnConnectedAsync()
    {
        ...
        await Groups.AddToGroupAsync(Context.ConnectionId, RealtimeConstants.Groups.User(userId));
    ...
    public override async Task OnDisconnectedAsync(Exception? exception)
    {
        ...
        await Groups.RemoveFromGroupAsync(Context.ConnectionId, RealtimeConstants.Groups.User(userId));
