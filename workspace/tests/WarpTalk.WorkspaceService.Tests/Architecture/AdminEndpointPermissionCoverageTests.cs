...
namespace WarpTalk.WorkspaceService.Tests.Architecture;
...
{
    private static readonly System.Reflection.Assembly Api = typeof(WarpTalk.WorkspaceService.API.Controllers.AdminWorkspacesController).Assembly;
