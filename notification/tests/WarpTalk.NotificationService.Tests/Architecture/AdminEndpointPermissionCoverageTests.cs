...
namespace WarpTalk.NotificationService.Tests.Architecture;
...
{
    private static readonly System.Reflection.Assembly Api = typeof(WarpTalk.NotificationService.API.Controllers.AdminAnnouncementsController).Assembly;
