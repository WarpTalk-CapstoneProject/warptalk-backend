...
public partial class MeetingDbContext : DbContext
{
    ...
    public virtual DbSet<RtcSessionRevocation> RtcSessionRevocations { get; set; }

    public virtual DbSet<RtcStreamParticipant> RtcStreamParticipants { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<RtcSessionRevocation>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("rtc_session_revocations_pkey");

            entity.ToTable("rtc_session_revocations", "meeting");

            entity.HasIndex(e => e.MeetingRoomId, "idx_rtc_session_revocations_meeting_room_id");
            ...
            entity.HasOne(d => d.MeetingRoom).WithMany(p => p.RtcSessionRevocations)
                .HasForeignKey(d => d.MeetingRoomId)
                .HasConstraintName("rtc_session_revocations_meeting_room_id_fkey");
        });

        modelBuilder.Entity<RtcStreamParticipant>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("rtc_stream_participants_pkey");

            entity.ToTable("rtc_stream_participants", "meeting");

            entity.HasIndex(e => e.MeetingRoomId, "idx_rtc_stream_participants_meeting_room_id");

            entity.HasIndex(e => e.UserId, "idx_rtc_stream_participants_user_id");
            ...
            entity.HasOne(d => d.MeetingRoom).WithMany(p => p.RtcStreamParticipants)
                .HasForeignKey(d => d.MeetingRoomId)
                .HasConstraintName("rtc_stream_participants_meeting_room_id_fkey");
        });
        ...
        modelBuilder.Entity<MeetingTrack>(entity =>
        {
            ...
            entity.HasIndex(e => e.RtcStreamParticipantId, "idx_meeting_tracks_rtc_stream_participant_id");
            ...
            entity.Property(e => e.RtcStreamParticipantId).HasColumnName("rtc_stream_participant_id");
            ...
            entity.HasOne(d => d.RtcStreamParticipant).WithMany(p => p.MeetingTracks)
                .HasForeignKey(d => d.RtcStreamParticipantId)
                .HasConstraintName("meeting_tracks_rtc_stream_participant_id_fkey");
        });
