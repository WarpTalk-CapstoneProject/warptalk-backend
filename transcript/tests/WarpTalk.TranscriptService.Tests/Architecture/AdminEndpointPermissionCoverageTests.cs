...
namespace WarpTalk.TranscriptService.Tests.Architecture;
...
{
    private static readonly System.Reflection.Assembly Api = typeof(WarpTalk.TranscriptService.API.Controllers.GlobalGlossariesController).Assembly;
