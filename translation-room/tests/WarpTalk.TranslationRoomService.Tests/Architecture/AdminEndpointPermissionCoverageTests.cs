...
namespace WarpTalk.TranslationRoomService.Tests.Architecture;
...
{
    private static readonly System.Reflection.Assembly Api = typeof(WarpTalk.TranslationRoomService.API.Controllers.AdminMeetingsController).Assembly;
