...
public class CreateTranslationRoomRequestValidatorTests
{
    ...
    {
        var model = new CreateTranslationRoomRequest(Guid.NewGuid(), null!, "Description", "INSTANT", 10, "vi", new List<string> { "en" }, null, null);
    ...
    public void Should_Have_Error_When_Title_Exceeds_MaxLength()
    {
        ...
        var model = new CreateTranslationRoomRequest(Guid.NewGuid(), longTitle, "Description", "INSTANT", 10, "vi", new List<string> { "en" }, null, null);
        var result = _validator.TestValidate(model);
        result.ShouldHaveValidationErrorFor(x => x.Title)
    ...
    {
        var model = new CreateTranslationRoomRequest(Guid.NewGuid(), "Valid Title", "Description", "INSTANT", 10, null!, new List<string> { "en" }, null, null);
        var result = _validator.TestValidate(model);
    ...
    {
        var model = new CreateTranslationRoomRequest(Guid.NewGuid(), "Valid Title", "Description", "INSTANT", 10, "vi", null!, null, null);
        var result = _validator.TestValidate(model);
    ...
    {
        var model = new CreateTranslationRoomRequest(Guid.NewGuid(), "Valid Title", "Description", "INSTANT", 0, "vi", new List<string> { "en" }, null, null);
        var result = _validator.TestValidate(model);
    ...
    public void Should_Have_Error_When_ScheduledAt_Is_In_The_Past()
    {
        ...
        var model = new CreateTranslationRoomRequest(Guid.NewGuid(), "Valid Title", "Description", "SCHEDULED", 10, "vi", new List<string> { "en" }, null, pastDate);
        var result = _validator.TestValidate(model);
